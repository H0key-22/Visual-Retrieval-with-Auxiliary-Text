...
def disable_torch_init():
    """
    Disable the redundant torch default initialization to accelerate model_name creation.
    """
    import torch
...
class AnswerGenerator:
    ...
    def load_model(self, model_name):
        ...
        Args:
            model_name: The model_name to load.
        """
...
class MistralAnswerGenerator(AnswerGenerator):
    ...
    def __init__(self, device, model_path, use_embedding_model=False):
        ...
        Args:
            device: The device to use for the model_name.
            model_path: The model_name to load.
            use_embedding_model: Whether to use the embedding model_name. Deprecated in the current version.
        """
        super().__init__()
        self.device = device
...
class GPT4AnswerGenerator(AnswerGenerator):
    ...
    def get_gpt4_answer(self, input):
        """Get the answer from the GPT-4 model_name.

        Args:
            input: The input to the model_name.
        """
        MAX_RETRIES = 5
        retries = 0
